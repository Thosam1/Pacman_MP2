...
public class Level0 extends SuperPacmanArea{
	...
	public void createArea(SuperPacmanBehavior behavior) {
        ...
        registerActor(new Door("superpacman/Level1",Level1.PLAYER_SPAWN_POSITION, Logic.TRUE, this, Orientation.UP,new DiscreteCoordinates(5,9)));	//Logic.TRUE -> portes allum�es, le player devrait pouvoir les traverser
        registerActor(new Door("superpacman/Level1",Level1.PLAYER_SPAWN_POSITION, Logic.TRUE, this, Orientation.UP,new DiscreteCoordinates(6,9)));
